...
public class PlayListActivity extends AppCompatActivity implements View.OnClickListener, View.OnLongClickListener {
    ...
    public boolean onLongClick(View view) {
        ...
        if (pos != -1) {
            new AlertDialog.Builder(this).setItems(new CharSequence[]{"Revise", "delete"}, new DialogInterface.OnClickListener() {
                @Override
                ...
                .setPositiveButton("Sure", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (url.toLowerCase().indexOf("rtsp://") != 0) {
                            Toast.makeText(PlayListActivity.this,"It is not a legal RTSP address, please add it again.",Toast.LENGTH_SHORT).show();
                            return;
                        }
